...
struct ContentView: View {
    ...
    @State private var editingItem: DuesheetItem?
    ...
    private func row(for item: DuesheetItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: DuesheetItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
